...
namespace Randoop
{
    ...
    public class RandomExplorer //: ExplorationContext
    {
        ...
        public void Explore(Common.ITimer timer, PlanManager planManager, MethodWeighing methodWeigthing,
            bool forbidNull, bool mutateFields, bool fairOpt)
        {
            ...
            Common.Timer.QueryPerformanceCounter(ref TimeTracking.generationStartTime);
            ...
            if (fairOpt)
            {
                ...
                for (; ; )
                {
                    ...
                    //field setting
                    if (mutateFields && this.actions.fieldList.Count > 0 && Common.Environment.Random.Next(2) == 0)
        ...
        private void ExploreMemberInternal(Common.ITimer timer, PlanManager planManager, bool forbidNull,
            MemberInfo m)
        {
            ...
            PlanDataBase planDB, bool forbidNull, MethodInfo method)
        {
            ...
            for (int i = 0; i < typesDesired.Length; i++)
            {
                ...
                {
                    int randArrayLength = Common.Environment.Random.Next(this.arrayMaxSize + 1);
                ...
                else
                {
                    ...
                    parameterMap[i] =
                        new Plan.ParameterChooser(i, possibleResultIndices[Common.Environment.Random.Next(possibleResultIndices.Count)]);
