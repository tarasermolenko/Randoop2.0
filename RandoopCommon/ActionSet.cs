...
namespace Randoop
{
    ...
    public class ActionSet
    {
        ...
        /// Timer 
        /// </summary>
        public class RRTimer : Common.ITimer
        {
        ...
        public MemberInfo RandomMethodOrConstructorRoundRobin()
        {
            ...
            int randomIndex = Common.Environment.Random.Next(roundRobinList.Count);
        ...
        {
            return methodsAndConstructorsArray[Common.Environment.Random.Next(methodsAndConstructorsArray.Length)];
        }
        ...
        public MemberInfo RandomActiveMethodorConstructor(Dictionary<Type, List<MemberInfo>> activeMembers, Type t)
        {
            try
            {
                ...
                int randnum = Common.Environment.Random.Next(memberList.Count); //xiao.qu@us.abb.com
        ...
        {
            return fieldList[Common.Environment.Random.Next(fieldList.Count)];
        }
