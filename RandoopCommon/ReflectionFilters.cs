...
namespace Randoop
{
    ...
    public class ConfigFilesFilter : IReflectionFilter
    {
        ...
        public static ConfigFilesFilter CreateDefaultConfigFilesFilter()
        {
            ...
            Common.StringReader r = new Common.StringReader();
            f.require_types.AddRange(r.Read(Common.Environment.RequiretypesDefaultConfigFile));
            f.require_members.AddRange(r.Read(Common.Environment.RequiremembersDefaultConfigFile));
            f.require_fields.AddRange(r.Read(Common.Environment.RequirefieldsDefaultConfigFile));
            f.forbid_types.AddRange(r.Read(Common.Environment.ForbidtypesDefaultConfigFile));
            f.forbid_members.AddRange(r.Read(Common.Environment.ForbidmembersDefaultConfigFile));
            f.forbid_fields.AddRange(r.Read(Common.Environment.ForbidfieldsDefaultConfigFile));
            return f;
        }
